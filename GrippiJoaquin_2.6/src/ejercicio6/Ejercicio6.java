 ...
 * Descripcion: Un programa que pide una serie de Datos, y segun la nota que tengas te califique entre insuficiente, aprobado, notable, sobresaliente, Matricula de honor y ademas que si la nota esta por encima de 10 o por debajo de  cero que notifique del error
 * Fecha:06/10/2025
 * 
 */
...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		...
		if (notaAcademica >= 0 && notaAcademica <=4 ) {
			...
			System.out.print("Nombre: " + nombre + "\nApellidos: " + apellidos + "\nCiclo Formativo: " + cicloFormativo + "\nNota Academica: " + notaAcademica + "(Matrícula de Honor)");
		}
		
		else  { System.out.print("La nota académica indicada es incorrecta");
